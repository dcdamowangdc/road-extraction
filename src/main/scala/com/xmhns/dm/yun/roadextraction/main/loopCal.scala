...
import com.xmhns.dm.yun.roadextraction.comm.gpsUtil.{cal_move_x, cal_move_y, get_distance, get_p, get_relative_x, get_relative_y, lat_to_y, lon_to_x, x_to_lon, y_to_lat}
import com.xmhns.dm.yun.roadextraction.comm.hive_comm.hive_insert_part
import com.xmhns.dm.yun.roadextraction.process.ProcessStep.getTime
...
object loopCal {
  def main(args: Array[String]): Unit = {
    ...
    var gpsRelA = spark.sql(s"select rcrd_time,drc0,rcrd_timea from bigdata_test.$gpsRelTn")
